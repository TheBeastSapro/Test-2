...
SECTIONS = [
 ...
 ("m13",540.600, 557.833, 0.42, "forty ships in a darkened column, and no German near them", "Estimations"),
 ("m13b",557.833,603.600, 0.72, "seventy-five minutes",                        "Exile"),
...
B += [
 ...
 ( 35.890, "oars in the water; the screw pump clears the bilge", "oar",     "impact",    -10.0, ["water", "passby"], True),
 ( 58.560, "renamed ALEXANDRIA and given away",                  "shipbell","hero_hit",   -8.0, None, True),
 ( 62.330, "she sails for Egypt, once",                          "sail",    "hero_hit",  -10.0, ["surge", "passby"], True),
 ...
 (119.000, "imperial ships arrive under sail, into no wind",      "sail",    "impact",    -11.0, ["passby"], True),
 (122.780, "a paddle warship runs a sailing ship down",          "impact",  "hero_hit",   -7.0, ["woodbreak", "water"], True),
 (123.733, "and opens her up",                                   "explo",   "hero_boom",  -7.0, ["woodbreak"], False),
 ...
 (257.000, "under full sail, leaving Stockholm",                 "sail",    "impact",    -10.0, ["passby"], True),
 ...
 (369.200, "it goes off in open water and hurts nobody",         "explo",   "hero_boom",  -6.0, ["surge", "water"], False),
 ...
 (473.000, "slow, wet and awkward to steer — the record",        "creak",   "impact",    -11.0, ["water", "passby"], True),
 ...
 (563.670, "the cruiser Inflexible then hits K22, and she burns", "impact",  "hero_hit",   -7.0, ["ramcrash", "exdist"], False),
 (573.900, "Fearless strikes K17 at near full speed, and cuts her open", "impact", "hero_boom", -5.0, ["ramcrash", "explo", "woodbreak"], False),
 (579.070, "K6 rams K4, and slices her nearly in half",          "impact",  "hero_hit",   -7.0, ["ramcrash", "water"], False),
 (584.070, "K17 goes up — the biggest burst in the video",       "explo",   "hero_boom",  -4.0, ["ramcrash", "surge"], False),
 (585.000, "survivors from K17 in the water, under it",           "water",   "impact",    -11.0, ["bubbles"], False),
 ...
 (707.500, "nobody has ever found her",                          "surge",   "hero_hit",  -10.0, ["bubbles", "wake"], True),

 # --- the fourteen measured fireballs of the collision column ----------
 (579.433, "fire takes hold along the column",                   "exdist",  "impact",     -9.0, None, False),
 (581.233, "another",                                            "explo",   "impact",     -8.0, None, False),
 (582.633, "and another",                                        "exdist",  "impact",     -9.0, None, False),
 (586.033, "K4 burning as she goes over",                        "explo",   "impact",     -8.0, ["water"], False),
 (587.800, "the cruiser alight",                                 "exdist",  "impact",     -9.5, None, False),
 (589.367, "still burning at seventy-five minutes",              "exdist",  "impact",    -10.0, None, False),
 (590.833, "and burning",                                        "explo",   "impact",     -9.0, None, False),
 # --- the Surcouf raid: three ships on fire, a plane over them ---------
 (653.150, "and the convoy goes up",                             "explo",   "hero_boom",  -5.0, None, False),
 (653.750, "the escort with it",                                 "explo",   "impact",     -7.0, ["water"], False),
 (654.033, "and the last of them",                               "exdist",  "impact",     -9.0, None, False),
 # --- water under ships that are actually moving ----------------------
 #     Reported as missing: a ship turning had no water on it. The bed is
 #     open sea, which is a place, not a movement — a hull under way needs
 #     its own pass-by.
 (121.500, "the paddle boat picks a direction and holds it",     "wake",    "swish",     -13.0, None, True),
 (185.000, "the turtle ship under oars",                         "passby",  "swish",     -14.0, None, True),
 (215.000, "she comes about",                                    "wake",    "swish",     -14.0, None, True),
 (346.000, "the Turtle crossing the harbour",                    "wake",    "swish",     -15.0, None, True),
 (449.000, "Novgorod stands up the Dnieper",                     "passby",  "swish",     -14.0, None, True),
 (461.000, "she turns for home",                                 "wake",    "swish",     -13.0, None, True),
 (513.000, "the K-boat holding station at twenty-four knots",    "wake",    "swish",     -12.5, None, True),
 (551.000, "two flotillas, running at speed",                    "passby",  "swish",     -13.0, None, True),
 (559.200, "K14 puts her helm over",                             "wake",    "hero_hit",   -9.0, ["passby"], False),
 (566.130, "the flotilla ahead turns back to help",              "passby",  "impact",    -11.0, ["wake"], False),
 (571.430, "and runs head-on into the Twelfth",                  "wake",    "impact",    -11.0, None, False),
 (687.000, "Thompson Lykes coming up in the dark",               "passby",  "swish",     -14.0, None, True),
]
