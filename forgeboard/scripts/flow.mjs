...
await p.goto('http://localhost:4174/#/forge', { waitUntil: 'networkidle' })

// 1. Ask Forge to build a board.
...
await p.goto('http://localhost:4174/#/boards', { waitUntil: 'networkidle' })
await p.waitForTimeout(400)
...
await p.goto('http://localhost:4174/#/forge/playground', { waitUntil: 'networkidle' })
...
await p.goto('http://localhost:4174/#/forge/library', { waitUntil: 'networkidle' })
...
await p.goto('http://localhost:4174/#/pay', { waitUntil: 'networkidle' })
